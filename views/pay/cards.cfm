  ...
  <div class="container">
    ...
    <div ng-show="selected.actual_payment==null">
      ...
      <div class="row bottom-buffer">
        <div class="col-md-12" align="center">
          ...
          <span class="col-md-8">
            <cfoutput>
              <button class="btn button btn-default" ng-show="!customAmount" ng-click="selected.actual_payment=selected.calculated_payment;makePayment()" ng-disabled="selected.calculated_payment=='Thinking...'"><i class="fas fa-check"></i> Mark as Paid: ${{selected.calculated_payment}}</button>
              &nbsp;
              <button class="btn button btn-default" ng-show="!customAmount" ng-disabled="selected.calculated_payment=='Thinking...'" ng-click="customAmount=true"><i class="fas fa-check-circle"></i> Let Me Mark a Custom Amount</button>
              <span ng-show="customAmount">
                ...
                <form name="customAmountForm" id="customAmountForm" class="form-inline">
                  ...
                  <button class="btn button btn-link" type="button" ng-disabled="selected.calculated_payment=='Thinking...'" ng-click="customAmount=false"><i class="fas fa-times-circle"></i> Cancel</button>

                  <button class="btn button btn-default" ng-click="makePayment()" ng-disabled="(selected.calculated_payment=='Thinking...'||customAmountForm.actual_payment.$invalid)"><i class="fas fa-check"></i> Record Payment</button>
                  </div>
                </form>
    ...
    <div class="row bottom-buffer">
      <div class="col-md-12" align="center">
        <span>
          <cfoutput>
            <button class="btn button btn-link" ng-disabled="selected.calculated_payment=='Thinking...'" ng-click="returnToList(1);cardPaymentForm.$setPristine(true);cardBalanceForm.$setPristine(true)"><span class="glyphicon glyphicon-circle-arrow-left"></span> Return to Cards</button>
          </cfoutput>
        </span>
      </div>
    </div>
